          ...
          child: Row(mainAxisAlignment: MainAxisAlignment.end, children: [
                      ...
                      text: Stack(
                        ...
                        children: [
                          SizedBox(
                            width: double.infinity,
                            child: Text(
                              "ابدأ العمل في الخدمة لو سمحت".tr,
                              textAlign: TextAlign.center,
                              style: Get.textTheme.headline6.merge(
                                TextStyle(color: Get.theme.primaryColor),
                              ),
            ...
            if (!_booking.value.cancel && _booking.value.status.order < Get.find<GlobalService>().global.value.onTheWay)
              MaterialButton(
                ...
                child: Text("إلغاء الطلب".tr, style: TextStyle(color: Get.theme.colorScheme.secondary,)),
                elevation: 0,
              ),
