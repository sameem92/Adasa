            ...
            Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  if ((category.subCategories?.length ?? 0) > 0) const Divider(height: 25, thickness: 0.5),
                  Wrap(
                    spacing: 5,
                    runSpacing: 5,
                    children: List.generate(category.subCategories?.length ?? 0, (index) {
                      ...
                      return GestureDetector(
                        ...
                        child: Container(
                          ...
                          child: Text(_category.name, style: Get.textTheme.caption.merge(const TextStyle(fontSize: 10))),
                        ),
                      );
                    }),
                  ),
