                  ...
                  SliverAppBar(
                    ...
                    leading: IconButton(
                      icon: Container(
                        ...
                        child: Icon(Icons.arrow_back_ios, color:  Get.theme.colorScheme.secondary),
                      ),
                      onPressed: () => {Get.back()},
                    ),
                    actions: [
                  ...
                  SliverToBoxAdapter(
                    child: Column(
                      ...
                      children: [
                        ...
                        // Image.network(_eService.images[1].url),
                                    ...
                                    child: Container(
                                        ...
                                        child: Stack(
                                          ...
                                          children: [
                                            Hero(
                                              tag:
                                              'e_services_galleries${_media?.id ?? ''}',
                                              child: ClipRRect(
                        ...
                        EServiceTilWidget(
                          ...
                          content: Row(
                            ...
                            children: [
                              ...
                              Wrap(
                                children:
                                Ui.getStarsList(_eService.rate, size: 22),
                              ),
                              Text(
                                "%s".trArgs(
                              ...
                              Obx(() {
                                ...
                                return ListView.separated(
                                  ...
                                  separatorBuilder: (context, index) {
                                    return const Divider(height: 35, thickness: 1.3);
                                  },
        ...
        children: [
          Row(
            children: [
              Expanded(
                child: Text(
                  _eService.name ?? '',
                  style: Get.textTheme.headline5.merge(const TextStyle(height: 1.1)),
                  maxLines: 2,
                  softWrap: true,
          ...
          Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              ...
              Row(
                children: [
                  Text('مدة الخدمة : ', style:TextStyle(color: Get.theme.hintColor,)),
      ...
      return Container(
        ...
        child: Row(
          children: [
                  ...
                  children: [
                    MaterialButton(
                      ...
                      child: Icon(Icons.remove,
                          color: Get.theme.primaryColor, size: 25),
                    ),
                    SizedBox(
                      width: 38,
                      child: Obx(() {
            ...
            if (_eService.priceUnit == 'fixed') const SizedBox(width: 10),
            Expanded(
