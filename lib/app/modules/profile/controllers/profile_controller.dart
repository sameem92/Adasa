...
class ProfileController extends GetxController {
  ...
  void onInit() {
    ...
    avatar.value =user.value.avatar !=null ?Media(thumb: user.value.avatar.thumb):avatar.value;

    // avatar.value =Get.find<AuthService>().user.value!=null? new Media(thumb: user.value.avatar.thumb !=null ?user.value.avatar.thumb :''):"";
    super.onInit();
  }
